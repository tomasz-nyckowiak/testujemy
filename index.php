...
<body>
		...
		<div class="accordion-item">
			...
			<div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">				
				<div class="accordion-body">
					...
					<div class="mt-2">
						<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addIncModal">
					...
					<ul id="paymentsMethodsList">
						<?php								
							for ($x = 0; $x < $paymentMethodsArraySize; $x++) {									
								...
								echo "<button type='button' class='edit' id='editPM$k'>Edytuj</button>";
								echo "<button type='button' class='delete' id='deletePM$k'>Usuń</button>";
								echo "<br>";								
							}
						?>
					</ul>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" id="addPaymentMethodBody">				
					<div id="messageAddPaymentMethod">				
						<div id="errorMessagePaymentMethod"></div>
	...
	<script src="./scripts/addIncome.js"></script>
