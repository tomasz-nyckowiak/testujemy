...
<body>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body run">
					...
					<input type="text" name="inputEditCategory" id="inputEditCategory" placeholder="" onchange="jazda2()"><br><br>					
	...
	<script>
		...
		function showMessageAddCat() {
			...
			$("#messageAdd").load("replace2.html #successAddCat");
		}
		...
		// EDIT CATEGORY
		$("#addCatLimitEdit").click(function(){
			if ($(this).is(':checked')) {
				//alert("checked");
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {	
			...
			$('#addCatModal').on('hidden.bs.modal', function(e) {
				$("#messageAdd").load("replace2.html #messageAdd");
