	...
	<script>		
		...
		$(document).ready(function() {			
			...
			/*$('#deleteCatModal').on('hidden.bs.modal', function(e) {				
				$("#messageDel").load("replace.html #areYouSure");
			});*/
			...
			$('.delete').click(function() {
				...
				$("#confirm").click(function() {					
					...
					$("#messageDel").load("replace.html #successDel");					
					$(".a").load("temp2.php");
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body run">
					<div id="message"></div>
					<form id="addCatModalForm" method="post">
						<input type="text" name="newCategory" id="inputNewCategory" required>					
						<div class="mt-3">
